...
export type Page = 'home' | 'family' | 'add' | 'member-detail' | 'settings' | 'child-settings' | 'get-verified' | 'my-documents' | 'add-document' | 'verify-someone' | 'shamir' | 'identity-bridge' | 'import-nsec' | 'credential-detail' | 'approve-verification';
